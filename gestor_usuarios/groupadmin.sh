...
# 2. ssh-copy-id informatica@192.168.0.104 --> UBUNTU
# 3. ssh-copy-id informatica@192.168.0.105 --> CENTOS
...
# --- USUARIOS por defecto ---
	# UBUNTU
		usuario_ubuntu=informatica
	# CENTOS
		usuario_centos=informatica
...
trap "rm -f $tempfile1 $tempfile2 $tempfile3 $tempfile4" 0 1 2 6 15
        ...
        0)
            ...
            do
				...
				# ---Se verifica que distribución linux es CentOS o Ubuntu---
					sistema_operativo=$(ssh $usuario_ubuntu@$ssh_ip "if [ -f $direccion_ubuntu ]; then echo 1; else echo 0; fi")

					if [ $sistema_operativo -eq 0 ]
					then
						sistema_operativo=$(ssh $usuario_centos@$ssh_ip "if [ -f $direccion_centos ]; then echo 2; else echo 0; fi")
					fi
				...
				# ---Se selecciona el tipo de destribución Linux CentOS o Ubuntu---
					case $sistema_operativo in
                        # ---UBUNTU---
						1)
                            existe_usuario=$(ssh $usuario_ubuntu@$ssh_ip "if grep -qi \"^$(cat $tempfile2):\" /etc/passwd; then echo 1; else echo 0; fi")

                            case $existe_usuario in
								0)
									ssh $usuario_ubuntu@$ssh_ip "sudo useradd -d /home/$(cat $tempfile2) -m -s /bin/bash $(cat $tempfile2)"
                        ...
                        # ---CENTOS---
						2)
                            existe_usuario=$(ssh $usuario_centos@$ssh_ip "if grep -qi \"^$(cat $tempfile2):\" /etc/passwd; then echo 1; else echo 0; fi")

                            case $existe_usuario in
								0)
									ssh $usuario_centos@$ssh_ip "sudo useradd -d /home/$(cat $tempfile2) -m -s /bin/bash $(cat $tempfile2)"
					...
					case $sistema_operativo in
						...
						1)
							...
							case $existe_usuario in
                                ...
                                ;;
								1)
									ssh $usuario_ubuntu@$ssh_ip "sudo userdel -r $(cat $tempfile2)"
						...
						2)
							...
							case $existe_usuario in
                                ...
                                ;;
								1)
									ssh $usuario_centos@$ssh_ip "sudo userdel -r $(cat $tempfile2)"
					...
					case $sistema_operativo in
						...
						1)
							...
							case $existe_usuario in
                                ...
                                ;;
								1)
									ssh $usuario_ubuntu@$ssh_ip "echo \"$(cat $tempfile2):$contrasenia\" | sudo chpasswd"
						...
						2)
							...
							case $existe_usuario in
                                ...
                                ;;
								1)
									ssh $usuario_centos@$ssh_ip "echo \"$(cat $tempfile2):$contrasenia\" | sudo chpasswd"
					...
					case $sistema_operativo in
						...
						1)
							...
							case $existe_usuario in
                                ...
                                ;;
								1)
									ssh $usuario_ubuntu@$ssh_ip "sudo chage -E $(date +'%Y-%m-%d' --date='-1 day') $(cat $tempfile2)"
						...
						2)
							...
							case $existe_usuario in
                                ...
                                ;;
								1)
									ssh $usuario_centos@$ssh_ip "sudo chage -E $(date +'%Y-%m-%d' --date='-1 day') $(cat $tempfile2)"
					...
					case $sistema_operativo in
						...
						1)
							...
							case $existe_usuario in
                                ...
                                ;;
								1)
									ssh $usuario_ubuntu@$ssh_ip "echo \"$(cat $tempfile2):$contrasenia_aleatoria\" | sudo chpasswd"
						...
						2)
							...
							case $existe_usuario in
                                ...
                                ;;
								1)
									ssh $usuario_centos@$ssh_ip "echo \"$(cat $tempfile2):$contrasenia_aleatoria\" | sudo chpasswd"
